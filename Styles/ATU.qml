...
<qgis minScale="1e+08" maxScale="0" version="3.28.3-Firenze" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories">
  ...
  <renderer type="basic">
    <styles>
      <style name="Області" layer="atu_oblast_data" expression="geometry_type($geometry)='Polygon'" min-zoom="-1" enabled="1" max-zoom="-1" geometry="2">
        <symbols>
          <symbol clip_to_extent="1" name="0" type="fill" frame_rate="10" force_rhr="0" alpha="1" is_animated="0">
            ...
            <layer pass="0" class="SimpleLine" enabled="1" locked="0">
              <Option type="Map">
                ...
                <Option name="line_color" type="QString" value="255,179,39,255"/>
      ...
      <style name="Райони" layer="atu_rayon_data" expression="geometry_type($geometry)='Polygon'" min-zoom="-1" enabled="1" max-zoom="-1" geometry="2">
        <symbols>
          <symbol clip_to_extent="1" name="0" type="fill" frame_rate="10" force_rhr="0" alpha="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
            ...
            <layer pass="0" class="SimpleLine" enabled="1" locked="0">
              <Option type="Map">
                ...
                <Option name="line_color" type="QString" value="73,145,253,255"/>
                <Option name="line_style" type="QString" value="solid"/>
      ...
      <style name="Територіальні громади" layer="atu_terhromad_data" expression="geometry_type($geometry)='Polygon'" min-zoom="-1" enabled="1" max-zoom="-1" geometry="2">
        <symbols>
          <symbol clip_to_extent="1" name="0" type="fill" frame_rate="10" force_rhr="0" alpha="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
            ...
            <layer pass="0" class="SimpleLine" enabled="1" locked="0">
              <Option type="Map">
                ...
                <Option name="draw_inside_polygon" type="QString" value="0"/>
                <Option name="joinstyle" type="QString" value="bevel"/>
                <Option name="line_color" type="QString" value="76,19,151,255"/>
                <Option name="line_style" type="QString" value="solid"/>
  ...
  <labeling type="basic">
    <styles>
      <style name="" layer="atu_oblast_data" expression="geometry_type($geometry)='Polygon'" min-zoom="-1" enabled="1" max-zoom="-1" geometry="2">
        <settings calloutType="simple">
          <text-style fontSizeUnit="Point" fontStrikeout="0" multilineHeightUnit="Percentage" allowHtml="0" forcedItalic="0" fontLetterSpacing="0" fontFamily="Open Sans" fontWordSpacing="0" fontKerning="1" textOrientation="horizontal" fontItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" forcedBold="0" multilineHeight="1" isExpression="1" capitalization="0" fontSize="10" fontUnderline="0" textOpacity="1" fieldName="" textColor="50,50,50,255" fontWeight="50" legendString="Aa" blendMode="0" useSubstitutions="0" previewBkgrdColor="255,255,255,255" namedStyle="Regular">
            <families/>
            <text-buffer bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferJoinStyle="128" bufferDraw="0" bufferBlendMode="0" bufferSize="1" bufferColor="250,250,250,255" bufferSizeUnits="MM"/>
