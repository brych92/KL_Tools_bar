...
<qgis minScale="1e+08" maxScale="0" version="3.28.3-Firenze" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories">
  ...
  <renderer type="basic">
    <styles>
      <style name="Polygons" layer="" expression="geometry_type($geometry)='Polygon'" min-zoom="-1" enabled="1" max-zoom="-1" geometry="2">
        <symbols>
          <symbol clip_to_extent="1" name="0" type="fill" frame_rate="10" force_rhr="0" alpha="1" is_animated="0">
            ...
            <layer pass="0" class="SimpleFill" enabled="1" locked="0">
              <Option type="Map">
                ...
                <Option name="color" type="QString" value="28,150,0,60"/>
                <Option name="joinstyle" type="QString" value="bevel"/>
                <Option name="offset" type="QString" value="0,0"/>
                <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
                <Option name="offset_unit" type="QString" value="MM"/>
                <Option name="outline_color" type="QString" value="228,255,23,163"/>
            ...
            <layer pass="0" class="PointPatternFill" enabled="1" locked="0">
              <Option type="Map">
                ...
                <Option name="displacement_x" type="QString" value="20"/>
                ...
                <Option name="seed" type="QString" value="428423568"/>
              </Option>
              <data_defined_properties>
                <Option type="Map">
                  <Option name="name" type="QString" value=""/>
              ...
              <symbol clip_to_extent="1" name="@0@1" type="marker" frame_rate="10" force_rhr="0" alpha="1" is_animated="0">
                ...
                <layer pass="0" class="SvgMarker" enabled="1" locked="0">
                  <Option type="Map">
                    ...
                    <Option name="color" type="QString" value="0,192,93,63"/>
                    <Option name="fixedAspectRatio" type="QString" value="0"/>
                    <Option name="horizontal_anchor_point" type="QString" value="1"/>
                    <Option name="name" type="QString" value="symbol/poi_embassy2.svg"/>
                    <Option name="offset" type="QString" value="0,0"/>
                    <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
                    <Option name="offset_unit" type="QString" value="MM"/>
          ...
          <symbol clip_to_extent="1" name="0" type="marker" frame_rate="10" force_rhr="0" alpha="1" is_animated="0">
            ...
            <layer pass="0" class="SimpleMarker" enabled="1" locked="0">
              <Option type="Map">
                ...
                <Option name="color" type="QString" value="231,113,72,100"/>
                <Option name="horizontal_anchor_point" type="QString" value="1"/>
                <Option name="joinstyle" type="QString" value="bevel"/>
  ...
  <labeling type="basic">
    <styles>
      <style name="" layer="pzf_data" expression="geometry_type($geometry)='Polygon'" min-zoom="12" enabled="0" max-zoom="-1" geometry="0">
        <settings calloutType="simple">
          <text-style fontSizeUnit="Point" fontStrikeout="0" multilineHeightUnit="Percentage" allowHtml="0" forcedItalic="0" fontLetterSpacing="0" fontFamily="Open Sans" fontWordSpacing="0" fontKerning="1" textOrientation="horizontal" fontItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" forcedBold="0" multilineHeight="1" isExpression="1" capitalization="0" fontSize="10" fontUnderline="0" textOpacity="1" fieldName="&quot;NazObPZF&quot;" textColor="50,50,50,255" fontWeight="50" legendString="Aa" blendMode="0" useSubstitutions="0" previewBkgrdColor="255,255,255,255" namedStyle="Regular">
            <families/>
            <text-buffer bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="0.69999999999999996" bufferJoinStyle="128" bufferDraw="1" bufferBlendMode="0" bufferSize="1" bufferColor="250,250,250,255" bufferSizeUnits="MM"/>
          ...
          <placement preserveRotation="1" fitInPolygonOnly="0" overlapHandling="PreventOverlap" lineAnchorType="0" maxCurvedCharAngleOut="-25" distUnits="MM" overrunDistance="0" lineAnchorClipping="0" placement="6" quadOffset="4" repeatDistanceUnits="MM" offsetType="0" centroidInside="0" lineAnchorTextPoint="FollowPlacement" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistanceUnit="MM" geometryGenerator="" repeatDistance="0" geometryGeneratorType="PointGeometry" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" priority="5" layerType="PointGeometry" rotationUnit="AngleDegrees" xOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" dist="0" distMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" placementFlags="10" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" polygonPlacementFlags="2" offsetUnits="MM" rotationAngle="0" maxCurvedCharAngleIn="25" geometryGeneratorEnabled="0" allowDegraded="0"/>
